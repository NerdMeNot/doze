...
doze run -- true
ps -o rss= -p "$(pgrep -f 'doze __daemon')"

# a booted engine's RSS — boot it, then read its process
doze wake app                  # or: doze shell app
...
**Next:** **[The engines](/guides/engines/)** — why doze runs Valkey, Kvrocks, and
DocumentDB — or **[Why doze](/why/doze/)** for the full case.
